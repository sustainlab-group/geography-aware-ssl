...
train_csv = "/atlas/u/buzkent/ImageNet/csvs/geolocation_clusters_train.csv"
test_csv = "/atlas/u/buzkent/ImageNet/csvs/geolocation_clusters_val.csv"
temporal = False
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            if epoch % args.ckpt_frequency == 0 or epoch == args.epochs - 1:
                ...
                }, is_best=False, filename=os.path.join(args.save_dir, './output_bs_2/checkpoint_{:04d}.pth.tar'.format(epoch)))
...
def save_checkpoint(state, is_best, filename='./output_bs_2/checkpoint.pth.tar'):
