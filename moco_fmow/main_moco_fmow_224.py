...
from data_loader.fmow_dataloader import CustomDatasetFromImages, CustomDatasetFromImagesTemporal, CustomDatasetWikiSatNet
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.aug_plus:
        ...
        augmentation = [
            ...
            # transforms.RandomResizedCrop(32), # previously
            ...
            # original w/o initial resize to 224/448
            transforms.RandomResizedCrop(224, scale=(0.2, 1.)),
            transforms.RandomApply([
                transforms.ColorJitter(0.4, 0.4, 0.4, 0.1)  # not strengthened
            ], p=0.8),
            ...
            # original w/ initial resize to 224
    ...
    if temporal == False:
        # print('Baseline Wikisatnet')
        # train_dataset = CustomDatasetWikiSatNet(
        ...
        print('Temporal')
        # print('exactly same as baseline')
        # print('exactly same as 32x32')
        print('exactly same as 32x32 with other transformations')
        aug = [
            # 32x32
            # transforms.Resize(64),
            # transforms.CenterCrop(64),
            ...
            # exactly same as 32x32 with other transformations
            transforms.Resize(224*2),
            transforms.CenterCrop(224*2),
            transforms.RandomResizedCrop(224),
            transforms.RandomApply([
