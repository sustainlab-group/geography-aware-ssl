# GeoImageNet Downloader

This is GeoImageNet dataset downloader. **You can create new datasets from subsets of ImageNet by specifying how many 
...
Parallel request processing is also implemented and **multiprocessing_workers parameter** have been also been added which by default is 8.
